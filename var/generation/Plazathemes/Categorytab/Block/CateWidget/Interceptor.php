...
class Interceptor extends \Plazathemes\Categorytab\Block\CateWidget implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function _beforeToHtml123()
    {
        ...
        if (!$pluginInfo) {
            return parent::_beforeToHtml123();
        } else {
            return $this->___callPlugins('_beforeToHtml123', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductCate($id = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductCate($id);
        } else {
            return $this->___callPlugins('getProductCate', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getThumbUrl($thumb = null)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getThumbUrl');
        if (!$pluginInfo) {
            return parent::getThumbUrl($thumb);
        } else {
            return $this->___callPlugins('getThumbUrl', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getThumbHoverUrl($thumb = null)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getThumbHoverUrl');
        if (!$pluginInfo) {
            return parent::getThumbHoverUrl($thumb);
        } else {
            return $this->___callPlugins('getThumbHoverUrl', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getThumbHover2Url($thumb = null)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getThumbHover2Url');
        if (!$pluginInfo) {
            return parent::getThumbHover2Url($thumb);
        } else {
            return $this->___callPlugins('getThumbHover2Url', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getIdentify()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getIdentify', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsDefault');
        if (!$pluginInfo) {
            return parent::getItemsDefault();
        } else {
            return $this->___callPlugins('getItemsDefault', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsDesktop');
        if (!$pluginInfo) {
            return parent::getItemsDesktop();
        } else {
            return $this->___callPlugins('getItemsDesktop', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsDesktopSmall');
        if (!$pluginInfo) {
            return parent::getItemsDesktopSmall();
        } else {
            return $this->___callPlugins('getItemsDesktopSmall', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsTablet');
        if (!$pluginInfo) {
            return parent::getItemsTablet();
        } else {
            return $this->___callPlugins('getItemsTablet', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsMobile');
        if (!$pluginInfo) {
            return parent::getItemsMobile();
        } else {
            return $this->___callPlugins('getItemsMobile', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShowAddtocart');
        if (!$pluginInfo) {
            return parent::getShowAddtocart();
        } else {
            return $this->___callPlugins('getShowAddtocart', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShowWishlist');
        if (!$pluginInfo) {
            return parent::getShowWishlist();
        } else {
            return $this->___callPlugins('getShowWishlist', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShowCompare');
        if (!$pluginInfo) {
            return parent::getShowCompare();
        } else {
            return $this->___callPlugins('getShowCompare', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsOnRow');
        if (!$pluginInfo) {
            return parent::getProductsOnRow();
        } else {
            return $this->___callPlugins('getProductsOnRow', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getcattabimage($thumb = null)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getcattabimage');
        if (!$pluginInfo) {
            return parent::getcattabimage($thumb);
        } else {
            return $this->___callPlugins('getcattabimage', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getCategorytaImage($cate_id)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategorytaImage');
        if (!$pluginInfo) {
            return parent::getCategorytaImage($cate_id);
        } else {
            return $this->___callPlugins('getCategorytaImage', func_get_args(), $pluginInfo);
        }
    }
