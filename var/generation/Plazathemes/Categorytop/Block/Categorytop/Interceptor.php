<?php
namespace Plazathemes\Categorytop\Block\Categorytop;

/**
 * Interceptor class for @see \Plazathemes\Categorytop\Block\Categorytop
 */
class Interceptor extends \Plazathemes\Categorytop\Block\Categorytop implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, \Magento\Rule\Model\Condition\Sql\Builder $sqlBuilder, \Magento\CatalogWidget\Model\Rule $rule, \Magento\Widget\Helper\Conditions $conditionsHelper, \Magento\Catalog\Model\CategoryFactory $categoryFactory, \Magento\Catalog\Model\ProductFactory $productFactory, \Magento\Catalog\Helper\Category $catalogCategory, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $productCollectionFactory, $catalogProductVisibility, $httpContext, $sqlBuilder, $rule, $conditionsHelper, $categoryFactory, $productFactory, $catalogCategory, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCatRootId');
        if (!$pluginInfo) {
            return parent::getCatRootId();
        } else {
            return $this->___callPlugins('getCatRootId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCatListTop');
        if (!$pluginInfo) {
            return parent::getCatListTop();
        } else {
            return $this->___callPlugins('getCatListTop', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryLink');
        if (!$pluginInfo) {
            return parent::getCategoryLink($category);
        } else {
            return $this->___callPlugins('getCategoryLink', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCatByPath');
        if (!$pluginInfo) {
            return parent::getCatByPath($parentId, $path);
        } else {
            return $this->___callPlugins('getCatByPath', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryLevel2');
        if (!$pluginInfo) {
            return parent::getCategoryLevel2();
        } else {
            return $this->___callPlugins('getCategoryLevel2', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListCfg');
        if (!$pluginInfo) {
            return parent::getListCfg($cfg);
        } else {
            return $this->___callPlugins('getListCfg', func_get_args(), $pluginInfo);
        }
    }
