...
class Interceptor extends \Plazathemes\Bestsellerproduct\Block\Bestsellerproduct implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBestsellerProduct');
        if (!$pluginInfo) {
            return parent::getBestsellerProduct();
        } else {
            return $this->___callPlugins('getBestsellerProduct', func_get_args(), $pluginInfo);
        }
    }
